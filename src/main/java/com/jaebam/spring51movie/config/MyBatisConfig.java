...
@Configuration
@MapperScan(basePackageClasses = com.jaebam.spring51movie.mapper.AdminMapper.class)
// basePackageClasses 해당 클래스부터 하위 패키지의 모든 클래스 스캔
// basePackages 역할은 위와 같으나 문자열로 받기 때문에 none-Type-Safety
